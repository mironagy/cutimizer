...
public class ProblemaAuxiliarDP extends ProblemaAuxiliar {
	...
	private int[][] item;
	/**
	 * La posición de los cortes guillotina en la solución
	 */
	 ...
	 *            daules
	 * @param print
	 *            si se debe imprimir el proceso o no (œtil para hacer debug)
	 */
	...
	/**
	 * Retorna el índice del punto de discretización más peque–o que la
	 * dimensión dada
	 * 
	 * @param size
	 *            la dimensión máxima
